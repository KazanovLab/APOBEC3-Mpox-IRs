"""
Standalone script: load results.pkl produced by test10.py and regenerate
the combined 4×5 heatmap figure (heatmap_all.pdf / heatmap_all.png).
...
parser = argparse.ArgumentParser(description="Plot combined 5×4 heatmap from test10 results.")
parser.add_argument("--mm", type=int, default=0,
                    help="Number of mismatches used in test10 run (default: 0)")
